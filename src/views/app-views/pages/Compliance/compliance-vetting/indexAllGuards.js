...
export class ComplianceVettingAllGuards extends Component {
						...
						<Card title="Filters" style={AppStyles.paddingBottom20}>
							...
							<Col md={5} lg={5}>
								...
								>
									...
									<Option value="Pending">Pending Audit Checks</Option>
								</Select>
								</Col>
								<Col md={5} lg={5}>
								<Select
								...
								>
									<Option value="SC user A">From Date to Date Range </Option>
								</Select>
								</Col>
								<Col md={4} lg={4}>
								<Button
...
export default ComplianceVettingAllGuards
