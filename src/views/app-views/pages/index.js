...
const Pages = ({ match }) => (
  <Suspense fallback={<Loading cover="content" />}>
    <Switch>
      ...
      <Route path={`${match.url}/subscriptions`} component={lazy(() => import(`./CompanyDetails/subscriptions`))} />
      ...
      <Route path={`${match.url}/site-detail`} component={lazy(() => import(`./Sites/site-profile`))} />
      ...
      <Route path={`${match.url}/mp-profile`} component={lazy(() => import(`./MobilePatrol/mp-profile`))} />
      ...
      <Route path={`${match.url}/key-holding-site-profile`} component={lazy(() => import(`./KeyHolding/key-holding-site-profile`))} />
