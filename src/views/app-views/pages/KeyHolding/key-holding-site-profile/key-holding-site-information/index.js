...
export class KeyHoldingSiteInformation extends Component {
                ...
                <Form layout="vertical">
                    ...
                    <Row justify="center">
                        <Col xs={24} sm={24} md={24} lg={24} >
                            <Card className="card" title="Edit Site Information" style={AppStyles.paddingBottom20}>
                                <Row gutter={16} justify="center">
                                    ...
                                    <Col xs={24} sm={24} md={6} lg={6}>
                                        <Form.Item
                                            ...
                                            hasFeedback
                                        >
                                            <Input disabled maxLength={30} style={componentStyles.borderColor} prefix={<MailOutlined />} />
                                        </Form.Item>
                                    </Col>
...
export default KeyHoldingSiteInformation
