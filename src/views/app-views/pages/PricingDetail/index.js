			...
			<>
				...
				<Row style={{ justifyContent: 'center', marginTop: 120, marginBottom: 100 }}>
					...
					<Col xs={0} sm={0} md={6} lg={6} >
						...
						<div className="p-3" style={{ marginLeft: 100, backgroundColor: 'white' }}>
							<div className="mt-4">
					...
					<Col xs={0} sm={0} md={12} lg={12} style={{ alignSelf: 'center' }}>
						{/* <Card style={{ marginTop: 100, marginLeft: 100, marginRight: 100 }}> */}
						<Card style={{ marginLeft: 100, marginRight: 100, paddingBottom: 25 }}>
					...
					<Col xs={24} sm={24} md={0} lg={0} style={{ alignSelf: 'center' }}>
						{/* <Card style={{ marginTop: 100, marginLeft: 100, marginRight: 100 }}> */}
						<Card style={{ marginTop: 100, paddingTop: 25, paddingBottom: 25 }}>
