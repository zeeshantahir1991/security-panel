                            ...
                            <Form layout="vertical" >
                                ...
                                <Row gutter={16}>
                                    ...
                                    <Col xs={24} sm={24} md={8} lg={8}>
                                        ...
                                        >
                                            <Input
                                                disabled name="mpSiteName" defaultValue={record?.mpSiteName ? record.mpSiteName : ""} type="text" style={componentStyles.borderColor} prefix={<UserOutlined />} />
                                        </Form.Item>
                                    </Col>
                                    ...
                                    <Col xs={24} sm={24} md={8} lg={8} style={AppStyles.marginTop40}>
                                        ...
                                        <Switch
                                            disabled style={componentStyles.switchStyle} size="small" defaultChecked={record?.status == "Active" ? true : false} ></Switch>
	                                        Status
									</Col>
                                </Row>
                            </Form>
